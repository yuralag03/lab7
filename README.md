...
4. Выбор действия по значению `mm`:
   ...
   - Завершить программу.
   #### Иначе:
   - Вывести "Ошибка: неверный месяц!"
5. **Конец**

### Блок схема
![Блок схема алгоритма](lab7(1).png)
...
int main() {
	...
	printf("Введите месяц и год (ММ ГГГГ):");
	...
	case 2:
		...
		break;
	case 3: 
		return printf("31 - дней в Марте"); 
		break;
	case 4: 
		return printf("30 - дней в Апреле"); 
		break;
	case 5: 
		return printf("31 - дней в Мае"); 
		break;
	case 6: 
		return printf("30 - дней в Июнь"); 
		break;
	case 7: 
		return printf("31 - дней в Июле"); 
		break;
	case 8: 
		return printf("31 - дней в Августе"); 
		break;
	case 9: 
		return printf("30 - дней в Сентябре"); 
		break;
	case 10: 
		return printf("31 - дней в Октябре"); 
		break;
	case 11: 
		return printf("30 - дней в Ноябре"); 
		break;
	case 12: 
		return printf("31 - дней в Декабре"); 
		break;
	default: printf("Ошибка: неверный месяц!"); 
	}
	return 0;
}
```
